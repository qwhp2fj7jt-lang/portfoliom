  ...
  return (
    <footer className="relative mt-10 border-t text-center border-gray-200/50 dark:border-zinc-700/50 dark:bg-zinc-900/80 backdrop-blur">
      ...
      <div className="mx-auto max-w-6xl px-6 lg:px-12 py-12 flex flex-col md:flex-row md:justify-between md:items-center gap-8">
        ...
        <div className="flex flex-col gap-2 text-sm text-gray-500 dark:text-gray-300 items-center">
        ...
        <div className="flex items-center gap-5 text-sm text-gray-500 dark:text-gray-300">
          <a
            href="https://github.com/zeynepbass"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-black dark:hover:text-white dark:text-gray-300 transition-all duration-300 hover:scale-110"
          >

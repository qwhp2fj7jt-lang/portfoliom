...
export default function ProjectsAndExperience() {
  ...
  return (
        ...
        <div className="mb-0">
          <CustomButton text="Tüm projeleri göster&nbsp;→"  onClick={() => router.push(`/projects`)}/>
        </div>

        <div className="flex items-center flex-col md:flex-row justify-between mt-10 mb-6">
       <div><h2 className="text-2xl font-bold">Deneyim</h2></div> 
...
<div className="hidden md:block w-14 h-14 rounded-lg overflow-hidden bg-gray-100 justify-center">
            ...
            <div>
            <MyGoal baslik="Intern" paragraf="Atak Domain" paragrafOne="Tem 2020 – Eyl 2020 · 3 ay"/>

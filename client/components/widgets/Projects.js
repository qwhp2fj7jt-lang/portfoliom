...
export default function Projects() {
          ...
          >
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-3">
                ...
                {project.yakinda && (
                  <span className="rounded-full border border-text-purple-500 bg-text-purple-500  px-2.5 py-0.5 text-xs font-medium text-purple-300 dark:border-amber-900 dark:bg-amber-900/20 dark:text-[#A23A44]">
                    Yakında
                  </span>
                )}
              </div>
  ...
  {project.description.split(" ").length > 20 && "..."}
            ...
            <ChevronRight
              size={18}
              className="ml-6 shrink-0 text-gray-400 transition-all duration-300 group-hover:translate-x-1 group-hover:text-[#C71518]"
            />
          </Link>
        ))}
              <div className="mb-0">

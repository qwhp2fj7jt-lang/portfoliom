...
export default function Card({ project }) {
  ...
  <div className="mx-auto max-w-3xl px-4 py-5">
        <AboutHeader
          ...
          paragraf={
            <>
              Projelerimde modern React mimarisi ve ölçeklenebilir durum
              yönetimi yaklaşımlarını kullanarak, temiz, sürdürülebilir ve
              yeniden kullanılabilir kod yapıları oluşturuyorum.
              <br />
              Geliştirme süreçlerimi Git ile versiyonlayarak{" "}
              <a
              ...
              üzerinden düzenli şekilde yayınlıyor ve sürekli iyileştirme
              prensibiyle ilerliyorum. üzerinden yayınlıyorum.
            </>
          }
        />
      </div>
